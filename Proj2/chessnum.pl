...
valueQueen([QX, QY], [X, Y], 1, BlackList, [[QX, QY]-v-[X, Y] | BlackList]) :-
    QX #= X.
valueQueen([QX, QY], [X, Y], 1, BlackList, [[QX, QY]-h-[X, Y] | BlackList]) :-
    QY #= Y.
valueQueen([QX, QY], [X, Y], 1, BlackList, [[QX, QY]-d-[X, Y] | BlackList]) :-
    abs(QY - Y) #= abs(QX - X).
valueQueen([QX, QY], [X, Y], 0, BlackList, BlackList) :-
...
valueBishop([BX, BY], [X, Y], 1, BlackList, [[BX, BY]-d-[X, Y] | BlackList]) :-
    abs(BY - Y) #= abs(BX - X).
valueBishop([BX, BY], [X, Y], 0, BlackList, BlackList) :-
    abs(BY - Y) #\= abs(BX - X).
